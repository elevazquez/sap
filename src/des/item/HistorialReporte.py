...
from geraldo import Report, landscape, ReportBand, Label, ObjectValue, SystemField, FIELD_ACTION_COUNT, FIELD_ACTION_SUM, BAND_WIDTH, Line, ReportGroup
...
class HistorialReporte(Report):
    ...
    class band_page_header(ReportBand):
        ...
        elements = [
            ...
            Label(text="Fase", top=0.8*cm, left=0),
            Label(text="Tipo Item", top=0.8*cm, left=7*cm),
            Label(text="Codigo", top=0.8*cm, left=10*cm),
            Label(text="Version", top=0.8*cm, left=13*cm),
            Label(text="Descripcion", top=0.8*cm, left=15*cm),
            Label(text="Estado", top=0.8*cm, left=19*cm),
            Label(text="Costo", top=0.8*cm, left=22*cm),
            Label(text="Complejidad", top=0.8*cm, left=25*cm)
        ]
    ...
    class band_detail(ReportBand):
        ...
        elements = [
            ...
            ObjectValue(attribute_name='id_tipo_item', top=0, left=7*cm),
            ...
            ObjectValue(attribute_name='costo', top=0, left=22*cm),
            ObjectValue(attribute_name='complejidad', top=0, left=25*cm)
        ]